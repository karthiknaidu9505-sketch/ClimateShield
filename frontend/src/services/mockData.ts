...
export const MOCK_LOCATIONS: LocationItem[] = [
  {
    ...
    factors: [
      ...
      { title: 'Severely Blocked Drainage', description: 'Only 23% drainage flow capacity — debris blockage confirmed by IoT sensor', impact: 'HIGH' },
  ...
  },
  {
    ...
    recommendedActions: [{ priority: 'MONITORING', title: 'Routine Sensor Check', description: 'Standard telemetry polling — no action required at current risk level.' }],
...
export const MOCK_INCIDENTS: Incident[] = [
  {
    ...
    summary: 'Rapid water accumulation at Railway Underpass Station Rd. IoT sensors report 94 cm water level, rising at 3.2 cm/hr. Electrical junction box at submersion risk. Road closure and pump deployment in progress.',
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'act-008', incidentId: 'inc-002', title: 'Monitor Sensor Array', description: 'Increase telemetry polling to every 5 minutes', priority: 'MONITORING', order: 3, isCompleted: true, completedAt: new Date(Date.now() - 2700000).toISOString() },
    ],
    notes: [
